...
function Footer() {
  return (
    <footer style={{ backgroundColor: 'var(--surface-container-lowest)', borderTop: '1px solid var(--outline-variant)', boxShadow: '0 -4px 6px -1px rgba(30,58,138,0.05)', marginTop: 'auto', paddingBottom: '100px' }}>
